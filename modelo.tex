...
\documentclass[dvips,abntfigtabnum,capchap,anapcustomindent,12pt]{abnt} 
...
%\renewcommand{\cftfigfont}{Figure} % Coloca a palavra Figura antes do número na lista de figuras.
...
\renewcommand{\ABNTchapterfont}{\normalsize\fontfamily{phv}\bfseries\selectfont} % Serve para colocar o título do capítulo no meio do texto
\renewcommand{\ABNTsectionfont}{\tiny\fontfamily{phv}\selectfont} % Tipo e Tamanho da fonte da seçãono meio do texto
\renewcommand{\ABNTsubsectionfont}{\normalsize\fontfamily{phv}\bfseries\selectfont}                      % Tamanho da fonte subseção
\renewcommand{\ABNTsubsubsectionfont}{\Huge\fontfamily{phv}\bfseries\itshape\selectfont}
...
\makeatletter
	...
	\def\l@subsection#1#2{\pagebreak[3]
       ...
       \begingroup
         ...
         \parfillskip -\@pnumwidth
         %\bfseries\itshape    
	    \fontfamily{phv}\bfseries\selectfont % Boldface removed. 2006nm %% <= \bfseries uncommented again
         \leavevmode          % TeX command to enter horizontal mode.
         #1\hfil \hbox to\@pnumwidth{\hss #2}\medskip\par%% <= \medskip inserted
       \endgroup}
	  ...
	  \def\l@subsubsection#1#2{\pagebreak[3]
       ...
       \begingroup
         ...
         \parfillskip -\@pnumwidth
         %\fontseries{b}                
	    \fontfamily{phv}\bfseries\itshape\selectfont % Boldface removed. 2006nm %% <= \bfseries uncommented again
         \leavevmode                 % TeX command to enter horizontal mode.
         #1\hfil \hbox to\@pnumwidth{\hss #2}\medskip\par%% <= \medskip inserted
       \endgroup}
    \makeatother
